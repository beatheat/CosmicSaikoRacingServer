...
public static class Resource
{
	...
	/// </summary>
	public static bool IsSame(this List<ResourceType> resourceA, List<ResourceType> resourceB)
	{
		if (resourceA.Count != resourceB.Count) return false;
		var resourceAClone = new List<ResourceType>(resourceA);
		var resourceBClone = new List<ResourceType>(resourceB);
		resourceA.Sort();
		resourceB.Sort();
		//정렬한 두 리스트가 동일한지 확인
		bool check = true;
	...
	/// </summary>
	public static bool Contains(this List<ResourceType> origin, List<ResourceType>? part)
	{
